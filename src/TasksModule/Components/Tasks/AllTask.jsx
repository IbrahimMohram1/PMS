                          ...
                          >
                            ...
                            <td className="px-4 py-3">
                              <span className="px-3 py-1 rounded-full text-sm font-medium">
                                {task.status === "ToDo" ? (
                                  <span className="bg-gray-400 px-2 py-1 rounded-lg text-white">
                                    To Do
                                  </span>
                                ) : task.status === "InProgress" ? (
                                  <span className="bg-indigo-300 px-2 py-1 rounded-lg text-black">
                                    In Progress
                                  </span>
                                ) : (
                            ...
                            <td className="relative">
                              ...
                              {openDropdown === task.id && (
                                <div className="absolute right-0 mt-2 z-20 bg-white border rounded-md">
                                  <ul className="flex flex-col gap-y-2 px-5 py-2">
                                    <li className="flex items-center gap-x-2 text-emerald-700">
                                      <FaEye /> View
                                    </li>
